...
const Experience = () => {
    return(
        <div className="content--body flex flex-col mx-auto max-w-screen-2xl px-[80px] bg-neutral-100 text-2xl py-36 max-md:px-[5px] dark:bg-slate-900">
            <button className="btn flex bg-zinc-300 py-1 px-5 rounded-2xl mx-auto dark:bg-slate-500 dark:text-slate-200 hover:bg-violet-400 dark:hover:bg-violet-400">Experience</button>
