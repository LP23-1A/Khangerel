...
const Work = () => {
  return (
    <div className="content--body flex flex-col text-gray-700 text-2xl mx-auto max-w-screen-2xl px-[80px] py-16 max-md:px-[20px] dark:bg-gray-900">
      ...
      <div className="containing flex flex-col mx-auto gap-16">
        <div className="work--right flex bg-slate-200 rounded-3xl justify-between drop-shadow-2xl max-md:flex-col">
          <div className="bg-zinc-100 rounded-l-3xl h-full w-full bg-slate-500 p-10 max-md:rounded-b-none max-md:rounded-t-3xl">
            <Left />
          </div>
        ...
        <div className="work--right flex bg-slate-200 rounded-3xl justify-between drop-shadow-2xl max-md:flex-col">
          <div className="right--fis flex flex-col w-fit p-10 bg-white rounded-l-3xl gap-8 max-md:rounded-b-none max-md:rounded-t-3xl">
            <div className="flex flex-col">
              <Right />
            </div>
              <Iconic />
